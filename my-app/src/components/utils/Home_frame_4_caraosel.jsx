...
const Home_frame_4_caraosel = ({images}) => {
  ...
  return (
    <div>
    <div className="py-[15vh] px-[10vw] md:px-0">
          <div style={{ gridTemplateColumns:"2fr 3fr 2fr"}} className="md:grid flex flex-col">
            ...
            {/* ---drone---- */}
             ...
             {/* ------dots images ---- */}                
                 <div className="flex justify-center items-center gap-[1rem] md:pt-[10vh] py-[4vh]">
...
export default Home_frame_4_caraosel
