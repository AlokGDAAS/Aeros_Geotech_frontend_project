           ...
           <div style={{padding:"100px 72px",backgroundColor:"#111B22"}}>
               <div style={{display:"grid",gridTemplateColumns:"1fr 1fr"}}>
                   ...
                   <div className='relative'>
                       <img src={assets.ab_frame_5_img} alt=''/>
                        <img src={assets.left_dotted_corner} alt='' style={{position:"absolute" ,bottom:"1.5%",right:"15%", zIndex:"1"}}/>
                        <img src={assets.right_dotted_corner} alt=''style={{position:"absolute",top:"5%",left:"1.25%", zIndex:"2"}}/>                       
                   </div>                
