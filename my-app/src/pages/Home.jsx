...
// const Home = () => {
//   return (
//     <div className='flex bg-[url(/public/asset/background_1.png)] bg-cover bg-center'>
//       <div>
//         <img src={assets.side_frame1} alt='' />
//       </div>
//       <div>
//           <NavBar/>
//         <div className='flex justify-center'>          
//               <img src={assets.banner_1} alt='' className='w-1/2'/>  
           
//         </div>
//         <div className='flex justify-center'>
//           <img src={assets.drone_1}/>
//         </div>
//         <div className='flex justify-center'>
//           <img src={assets.bottom_left} alt='' className='h-8'/>
//           <img src={assets.bottom_middle} alt=''/>
//           <img src={assets.bottom_right} alt='' className='h-8 bottom-0'/>
